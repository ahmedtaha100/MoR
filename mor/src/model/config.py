...
class MoRConfig:
    ...
    def __post_init__(self):
        ...
        assert self.num_recursion_steps >= 1, "num_recursion_steps must be >= 1"
        ...
        assert 0.0 < self.capacity_ratio <= 1.0, "capacity_ratio must be in (0, 1]"
    ...
    def get_capacity_schedule(self) -> list[float]:
        return [
            (self.num_recursion_steps - i) / self.num_recursion_steps
